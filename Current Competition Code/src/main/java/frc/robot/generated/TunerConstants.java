...
import frc.robot.SwerveUtils.TurnConstants;
...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(TurnConstants.KP).withKI(TurnConstants.KI).withKD(TurnConstants.KD)
        .withKS(TurnConstants.KS).withKV(TurnConstants.KV).withKA(TurnConstants.KA)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(DriveConstants.KP).withKI(DriveConstants.KI).withKD(DriveConstants.KD)
        .withKS(DriveConstants.KS).withKV(DriveConstants.KV);
    ...
    private static final Current kSlipCurrent = Amps.of(15.0);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.006591796875);
